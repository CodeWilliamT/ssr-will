...
uninstall_ss() {
        ...
        then
                ...
                case $os in
                        'ubuntu'|'debian')
                                update-rc.d -f ss-will remove
                                ;;
                        'centos')
                                chkconfig --del ss-will
                                ;;
                esac
...
install() {
        ...
        then 
                cp $will_dir/ss-will /etc/init.d/
                chmod +x /etc/init.d/ss-will
                case $os in
                        'ubuntu'|'debian')
                                update-rc.d ss-will defaults
                                ;;
                        'centos')
                                chkconfig --add ss-will
                                chkconfig ss-will on
                                ;;
                esac            
